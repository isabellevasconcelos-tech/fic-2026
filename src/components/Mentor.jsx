...
export default function Mentor() {
  ...
  return (
    <button
      ...
      className="fixed bottom-[5.5rem] right-4 z-[60] w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:scale-110 active:scale-95"
      style={{
